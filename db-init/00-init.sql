...
DROP TRIGGER IF EXISTS trg_ticket_decrement ON tickets;
...
DROP TRIGGER IF EXISTS trg_order_cancel_release ON orders;
...
DROP TRIGGER IF EXISTS trg_ticket_refund_release ON tickets;
